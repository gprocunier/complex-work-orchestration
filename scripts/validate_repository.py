...
CWO_CORE_ALLOWED_IMPORTS = {
    ...
    "work_sizing": {"checked_command", "native_containment", "policy"},
...
def validate_repository() -> list[str]:
    ...
    require_doc_terms(
        ...
        [
            ...
            "benchmark gate",
            "OpenCode is the first open-source harness exemplar",
            "OpenShift AI vLLM is the local serving exemplar",
    ...
    require_doc_terms(
        ...
        [
            ...
            "--dry-run --json",
            "fails closed",
            "Verified against ChatGPT UI on July 8, 2026",
            "--confirm-only",
            "scripts/ingest_chatgpt_share_return.py",
