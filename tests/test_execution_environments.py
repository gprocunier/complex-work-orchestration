...
class ExecutionEnvironmentTests(unittest.TestCase):
    ...
    def test_opencode_dispatch_is_secret_free_and_not_executed(self) -> None:
        ...
        self.assertEqual(envelope["access_profile_details"]["provider_keys"], ["openshift_ai_vllm"])
        self.assertIn("CWO_OPENSHIFT_AI_VLLM_API_KEY", json.dumps(envelope))
    ...
    def test_opencode_dispatch_resolves_bound_model_profile(self) -> None:
        ...
        self.assertEqual(envelope["access_profile"], "rhoai-vllm")
        self.assertEqual(envelope["access_profile_details"]["status"], "available")
    ...
    def test_connected_glm_primary_environment_splits_pm_architect_and_counter_review(self) -> None:
        ...
        self.assertEqual(architect["access_profile"], "rhoai-glm-bf16")
        self.assertEqual(architect["access_profile_details"]["status"], "offline")
        ...
        self.assertEqual(pm["access_profile"], "codex-connected-shell")
